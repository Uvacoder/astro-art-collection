    ...
    return (
            <div id="gallery" className="flex flex-col items-center">
                ...
                <div style={{gridAutoRows: '10px'}} className="m-auto grid w-full lg:w-[75vw] md:w-[80vw]  grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                    ...
                    <Pin size="large" img="https://cdn.leonardo.ai/users/3d23d645-76e1-4b8d-83cf-0ef4104e7b72/generations/15a779b6-4307-43ed-842f-0447b82ad400/variations/Default_Spirit_fox_ember_spark_logo_style_2_15a779b6-4307-43ed-842f-0447b82ad400_1.jpg?w=512" />
